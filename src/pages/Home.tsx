      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Shree Lakshmi Clinic has all facilities.We are specialist in Pediatric, Infertility, Skin, Diabetes, Ortho , Gyneology etc…</p>
          </div>
