...
export const Signup = () => {
  ...
  }, [user, navigate, success, returnUrl]);
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      // Check if user is new and add to database if needed
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <div className="bg-white py-10 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-gray-100">
          {success ? (
            <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl mb-6 text-center font-medium">
